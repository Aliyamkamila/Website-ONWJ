...
const ManageAngkaStatistikTJSL = () => {
    ...
    const fetchStatistics = async () => {
        try {
            setLoading(true);
            const response = await apiClient.get('/v1/admin/tjsl/statistik');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await apiClient.post('/v1/admin/tjsl/statistik/bulk-update', {
                statistics
            });
    ...
    const handleReset = async () => {
        ...
        try {
            setSaving(true);
            const response = await apiClient.post('/v1/admin/tjsl/statistik/reset');
            ...
            toast.error('❌ Gagal reset statistik');
        } finally {
            setSaving(false);
        }
    };
