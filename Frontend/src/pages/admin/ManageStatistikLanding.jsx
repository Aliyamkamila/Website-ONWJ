...
import { FaSave, FaEdit, FaClock, FaAward, FaHandshake, FaUsers, FaUndo } from 'react-icons/fa';
...
const initialStatistik = {
    tahunPengalaman: {
        ...
        description: 'Pengalaman perusahaan di industri minyak dan gas'
    },
    penghargaanDiterima: {
        value: 35,
        ...
        description: 'Total penghargaan yang diterima perusahaan'
    },
    pelangganPuas: {
        value: 1750,
        ...
        description: 'Jumlah pelanggan yang puas dengan layanan kami'
    },
    stafProfesional: {
        value: 120,
        ...
        description: 'Tenaga ahli dan profesional yang bekerja di perusahaan'
    }
};
...
const ManageStatistikLanding = () => {
    ...
    const handleSave = () => {
        if (window.confirm('Apakah Anda yakin ingin menyimpan perubahan statistik landing page?')) {
            // TODO: Kirim data ke backend API
            console.log('Saving statistik landing:', tempStatistik);
        ...
        <div>
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Update angka statistik perusahaan di halaman utama website</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-blue-800">
                            Statistik ini akan ditampilkan di <strong>Homepage/Landing Page</strong> pada section profil perusahaan.
                            Format: <strong>"20+ Tahun Pengalaman | 35+ Penghargaan Diterima | 1,750+ Pelanggan Puas | 120+ Staf Profesional"</strong>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    {Object.entries(displayData).map(([key, item]) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center mb-4">
                                <div className="p-3 bg-blue-100 rounded-lg text-blue-600 mb-3">
                                    {item.icon}
                                </div>
                            ...
                            {isEditing ? (
                                <div className="mb-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 text-2xl font-bold border-2 border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-center"
                                        min="0"
                                    />
                                </div>
                            ) : (
            ...
            {/* Preview Banner */}
            <div className="mt-8 bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-8">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-yellow-800">
                            Data statistik ini muncul di halaman pertama website (first impression). 
                            Pastikan data sudah akurat dan diverifikasi oleh pimpinan sebelum menyimpan perubahan.
                        </p>
                    </div>
                </div>
            </div>
