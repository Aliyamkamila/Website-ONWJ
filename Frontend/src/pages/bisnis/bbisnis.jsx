  ...
  return (
    <div className="relative bg-white">
      ...
      <div className="section-container relative">
        ...
        {/* ===== STAKEHOLDERS - IMPROVED STRUCTURE ===== */}
        <section className="py-grid-10 bg-white" id="stakeholder">
          
          <div className="text-center mb-grid-8">
            <span className="inline-block px-grid-4 py-grid-2 bg-secondary-100 text-secondary-700 rounded text-body-sm font-semibold mb-grid-2">
              Jaringan Kolaborasi
            </span>
            <h2 className="text-display-md sm:text-display-lg font-heading font-bold text-secondary-900 mb-grid-2">
              Mitra Pemerintah
            ...
            <p className="text-body-md text-secondary-600 max-w-2xl mx-auto">
              Sinergi dengan berbagai instansi pemerintah untuk mendukung operasional berkelanjutan
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-grid-5">
              {stakeholderGroups.map((group, index) => (
                <article 
                  key={index}
                  className="flex flex-col bg-white border border-secondary-200 rounded overflow-hidden hover:shadow-sm hover:border-primary-600 transition-all duration-300"
                  tabIndex={0}
                >
                  {/* Header - Fixed Height */}
                  <div className="flex-shrink-0 p-grid-5 border-b border-secondary-100 bg-secondary-50">
                    <div className="flex items-center gap-grid-3 mb-grid-3">
                      <span className="flex-shrink-0 w-7 h-7 rounded bg-secondary-900 text-white flex items-center justify-center font-bold text-body-sm">
                        {index + 1}
                      </span>
                      <h3 className="flex-1 font-heading font-bold text-body-md text-secondary-900 leading-tight">
                        {group.title}
                      </h3>
                    </div>
                    ...
                    <div className="flex items-center gap-grid-2">
                      <FaUsers className="w-3.5 h-3.5 text-secondary-500" />
                      <span className="text-body-sm font-semibold text-secondary-700">
                        {group.count} Instansi
                      </span>
                    </div>
                  </div>
                  
                  {/* Content - Flexible Height */}
                  <div className="flex-1 p-grid-5">
                    <ul className="space-y-grid-2.5" role="list">
                      {group.departments.map((dept, idx) => (
                        <li 
                          key={idx}
                          className="flex items-start gap-grid-2.5 text-body-sm text-secondary-700 leading-relaxed"
                        >
            ...
            <div className="mt-grid-8 text-center">
              <div className="inline-flex items-center gap-grid-2 px-grid-6 py-grid-3 bg-secondary-50 border border-secondary-200 rounded">
                <FaHandshake className="w-5 h-5 text-primary-600" />
                <span className="font-semibold text-body-sm text-secondary-900">
                  Kolaborasi berkelanjutan untuk pertumbuhan bersama
                </span>
              </div>
            </div>
          </div>
