...
Route::prefix('v1/admin')->group(function () {
    // Note: Uncomment middleware if you want to protect these routes
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/testimonials/{id}', [TestimonialController::class, 'show'])->where('id', '[0-9]+');
...
Route::prefix('v1/admin')->group(function () {
    // Route::middleware(['auth:sanctum', 'admin_auth'])->group(function () {
        ...
        Route::get('/testimonials/{id}', [TestimonialController::class, 'show'])->where('id', '[0-9]+');
        Route::post('/testimonials/{id}', [TestimonialController::class, 'update'])->where('id', '[0-9]+');
        Route::delete('/testimonials/{id}', [TestimonialController::class, 'destroy'])->where('id', '[0-9]+');
        Route::post('/testimonials/bulk-delete', [TestimonialController::class, 'bulkDelete']);
        Route::post('/testimonials/{id}/toggle-featured', [TestimonialController::class, 'toggleFeatured'])->where('id', '[0-9]+');
